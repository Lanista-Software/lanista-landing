...
<template>
  <form
    id="contact" class="flex flex-col space-y-4 rounded-2xl border border-border-color bg-white p-8"
  ...
  >
    ...
    <div class="flex flex-col space-y-2">
      ...
      <LuiInput
        id="name" v-model="name" type="text" name="name" block rounded :placeholder="getStaticDataForLang.namePlaceholder"
    ...
    <div class="flex flex-col space-y-2">
      ...
      <LuiInput
        id="email" v-model="email" type="email" name="email" block rounded :placeholder="getStaticDataForLang.emailPlaceholder"
    ...
    <div class="flex flex-col space-y-2">
      ...
      <LuiInput
        id="subject" v-model="subject" type="text" name="subject" block rounded
    ...
    <div class="flex flex-col space-y-2">
      ...
      <LuiTextarea
        id="message" v-model="message" :resize="false" name="message" block rounded
        :placeholder="getStaticDataForLang.messagePlaceholder" :state="errors.message ? true : undefined"
      ></LuiTextarea>
    ...
    <div class="flex flex-col pt-2">
      <LuiButton color="danger" block rounded>
        {{ getStaticDataForLang.send }}
      </LuiButton>
    </div>
  </form>
</template>
