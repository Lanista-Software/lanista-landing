            ...
            <AtomsContainer>
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4 z-50">
                        <MolLangSelect @language-selected="handleLang" :active-lang="locale" />
                        ...
                        <NuxtLink class="hidden md:block" to="/#contact">
                            <LuiButton @click="handleClick" block color="danger" rounded="full" tag="div">
                                Contact
                            </LuiButton>
                        </NuxtLink>
                    </div>
                    ...
                    <div class="pt-6">
                        ...
                        <div class="pt-8">
                            <NuxtLink @click="toggleMenu" to="/#contact">
                                <LuiButton @click="handleClick" block class="items-center justify-center flex"
                                    color="danger" rounded="full" tag="div">
                                    Contact
                                </LuiButton>
                            </NuxtLink>
                        </div>
